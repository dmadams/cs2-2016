...
/**
* Initially, the variables a, b, and x are set to the values 174, 85, and 0.
* If b is odd, a is added to x. Then a is multiplied by 2 and b is divided by 2
* (discarding the remainder). This continues until b = 0. When the computation
* ends then, a = 22272, b = 0, and x = 14790. 
*/
